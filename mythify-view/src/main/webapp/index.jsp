        ...
        <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                ...
                <head>
                    ...
                    <!-- Icono de la página -->
                    <link rel="icon" type="image/x-icon" href="<c:url value="
                        ${pageContext.request.contextPath}/img/icon.svg" />">
                    <!-- Link footer -->
                    <link rel="stylesheet"
                                        ...
                                        <c:choose>
                                            <c:when test="${not empty posts}">
                                                <c:forEach var="post" items="${posts}">
                                                    <c:if
                                                        test="${post != null && post.usuario != null && post.titulo != null && post.contenido != null}">
                                                        <article class="article-post">
                                                            <div class="head-article-post">
                                                                <c:if test="${!post.anclado}">
                                                                    <a
                                                                        href="<c:url value='/SVPost?id=${post.idPost}'/>">
                                                                </c:if>
                                                                <div class="left-head-article">
                                                                    <img src="${pageContext.request.contextPath}/imgUsers/${post.usuario.avatar}"
                                                                        alt="Profile Picture" class="profile-pic" />

                                                                    <c:choose>
                                                                        <c:when
                                                                            test="${not empty post.fechaHoraEdicion}">
                                                                    ...
                                                                    <span class="span-post-header">
                                                                        @${empty post.usuario.nombre ? 'Anonymous' :
                                                                        post.usuario.nombre} •
                                                                        ${tiempoTranscurrido}
                                                                    </span>
                                                                    <span class="span-post-label">
                                                                        ${empty post.categoria ? 'Uncategorized' :
                                                                        post.categoria}
                                                                    </span>

                                                                    <c:if test="${post.anclado}">
                                                                        <img src="<c:url value='/img/pin-white.svg' />"
                                                                            alt="Pin icon">
                                                                    </c:if>
                                                                </div>
                                                                <c:if test="${!post.anclado}">
                                                                    ...
                                                                    <div class="right-head-article">
                                                                        <button type="button" class="btn-option"
                                                                            ...
                                                                            <img src="<%= request.getContextPath()%>/img/options-post.svg"
                                                                                alt="Opciones" width="20">
                                                                        </button>

                                                                        <div class="dropdown-menu"
                                                                            id="dropdown-${post.idPost}"
                                                                            style="display: none;">
                                                                            <form action="SVPost?id=${post.idPost}"
                                                                                method="post">
                                                                                ...
                                                                                <c:choose>
                                                                                    ...
                                                                                    <c:otherwise>
                                                                                        <input type="hidden"
                                                                                            ...
                                                                                            value="anclarPost">
                                                                                        <button
                                                                                            type="submit">ANCLAR</button>
                                                                                    </c:otherwise>
                                                                                </c:choose>
                                                                            </form>

                                                                            <a
                                                                                href="<c:url value='/SVPost?id=${post.idPost}&action=editarPost' />">EDITAR</a>

                                                                            <button type="button" class="btn-delete"
                                                                                data-post-id="${post.idPost}">ELIMINAR</button>
                                                                        </div>
                                                                    </div>
                                                                </c:if>
                                                            </div>
                                                            ...
                                                            <c:set var="postLikeados"
                                                                value="${sessionScope.postsLikeados}" />
                                                            <div class="footer-post">
                                                                <form action="SVPost" method="post">
                                                                    ...
                                                                    <c:choose>
                                                                        <%-- Verificamos si el post actual está en la
                                                                            lista de posts likeados --%>
                                                                            <c:when
                                                                                test="${fn:contains(postLikeados, post)}">
                                                                                <input type="hidden" name="action"
                                                                                    value="desLikearPost">
                                                                                <button class="btn-footer">
                                                                                    <img src="<c:url value='/img/heart-red.svg' />"
                                                                                        alt="Dislike">
                                                                                    ${post.cantLikes}
                                                                                </button>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                <input type="hidden" name="action"
                                                                                    value="likearPost">
                                                                                <button class="btn-footer">
                                                                                    <img src="<c:url value='/img/heart-black.svg' />"
                                                                                        alt="Like">
                                                                                    ${post.cantLikes}
                                                                                </button>
                                                                            </c:otherwise>
                                                    ...
                                                    <article class="hot-post">
                                                        ...
                                                        <div class="footer-hot-post">
                                                            <form action="SVPost" method="post">
                                                                ...
                                                                <input type="hidden" name="isView" value="false">
                                                                <c:choose>
                                                                    <%-- Verificamos si el post actual está en la lista
                                                                        de posts likeados --%>
                                                                        <c:when
                                                                            test="${fn:contains(sessionScope.postsLikeados, post)}">
                                                                            <input type="hidden" name="action"
                                                                                value="desLikearPost">
                                                                            <button class="btn-footer-hot-post">
                                                                                <img src="<c:url value='/img/heart-white.svg' />"
                                                                                    alt="Dislike">
                                                                                ${post.cantLikes}
                                                                            </button>
                                                                        </c:when>
                                                            ...
                                                            <a href="<c:url value='/SVPost?id=${post.idPost}'/>">
                                                                <button class="btn-footer-hot-post">
                                                                    <img src="<c:url value='/img/comments-white.svg' />"
                                                                        alt="Comments">
                                                                    ${post.comentarios != null ? post.comentarios.size()
                                                                    : 0}
                                                                </button>
                                                            </a>
                                                        </div>
