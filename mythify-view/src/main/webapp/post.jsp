                                                ...
                                                <article class="article-post">
                                                    <div class="head-article-post">
                                                        <div class="left-head-article">
                                                            ...
                                                            <% Date fechaCreacion=post.getFechaHoraCreacion(); String
                                                                tiempoTranscurrido=CalcularTiempo.tiempoTranscurridoDesde(fechaCreacion);
                                                                %>
                                                                <span class="span-post-header">@<%=post.getUsuario().getNombre()%> • <%=
                                                                            tiempoTranscurrido%>
                                                                </span>
